 ...
 * reason: this is demoed in a lecture hall. Venue wifi fails, and a terminal that
 * cannot see a person because a .task file did not download is a terminal that
